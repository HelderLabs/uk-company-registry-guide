...
> >             >         >         > 2. 2. **Note the company number** — use this for all subsequent lookups, not the name
> >             >         >         >    3. 3. **Check Officers** — identify current and former directors, note nomination patterns
> >             >         >         >       4. 4. **Check PSC** — identify declared beneficial owners, trace corporate PSCs upward
> >             >         >         >          5. 5. **Review Filing History** — look for ownership changes, charges, address changes
> >             >         >         >             6. 6. **Cross-reference officer names** — search each officer's personal appointments to map their wider network
> >             >         >         >                7. 7. **Trace the holding structure** — follow ownership up through parent companies
> >             >         >         >                   8. 8. **Document everything** — log every source URL, filing date, and company number
> >             >         >         >                     
> >             >         >         >                      9. ---
> >             >         >         >                     
> >             >         >         >                      10. ## Disclaimer
> >             >         >         >                     
> >             >         >         >                      11. All information available through Companies House is public and freely accessible under UK law. This guide is for educational and research purposes. All research should be conducted using publicly available sources only.
